...
const HorizontalNavBar = () => {
    ...
    const navItems = [
        ...
        },
        {
            ...
            link: null,
            subItems: [
                { text: "Vet Profiles", icon: <People fontSize="large" style={{ color: '#1976d2' }} />, link: "/vetdashboard/vet-profiles" }, // Individual vet profile
                { text: "Appointments History", icon: <EventNote fontSize="large" style={{ color: '#1976d2' }} />, link: "/vetdashboard/appointments" }, // Updated icon for appointments
            ],
        },
        {
            text: "Agrovet Hub",
            ...
            link: null,
            subItems: [
                { text: "Products", icon: <LocalMall fontSize="large" style={{ color: '#1976d2' }} />, link: "/vetdashboard/products" }, // LocalMall for products
                { text: "Order Management", icon: <Receipt fontSize="large" style={{ color: '#1976d2' }} />, link: "/vetdashboard/order-management" }, // Receipt for order management
            ],
        },
        {
            ...
            link: null,
            subItems: [
                { text: "Blogs", icon: <Article fontSize="large" style={{ color: '#1976d2' }} />, link: "/vetdashboard/blogs" },
                { text: "Webinars", icon: <LiveTv fontSize="large" style={{ color: '#1976d2' }} />, link: "/vetdashboard/webinars" }, // LiveTv for webinars
            ],
        },
        {
            ...
            link: null,
            subItems: [
                { text: "Discussions", icon: <Comment fontSize="large" style={{ color: '#1976d2' }} />, link: "/vetdashboard/discussions" }, // Comment for discussions
            ],
        },
    ];
