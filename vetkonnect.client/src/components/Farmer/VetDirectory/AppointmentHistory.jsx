...
class AppointmentHistory extends Component {
    constructor(props) {
        ...
        this.state = {
            appointmentHistory: [
                { id: 1, dateTime: '2024-09-20 10:00 AM', client: 'Michael Kasuku', venue: 'Veterinary Clinic A', status: 'Completed' },
                { id: 2, dateTime: '2024-09-21 11:00 AM', client: 'Daisy Lopez', venue: 'Veterinary Clinic B', status: 'Completed' },
                { id: 3, dateTime: '2024-09-22 09:30 AM', client: 'Josphine Otieno', venue: 'Veterinary Clinic C', status: 'Missed' },
            ],
            searchQuery: '',
            sortDirection: 'asc',
                        ...
                        <Card variant="outlined" sx={{ marginBottom: 2 }}>
                            <CardContent>
                                <Typography variant="h5" sx={{ display: 'flex', alignItems: 'center', marginBottom: 2 }}>
                                    <Pets fontSize="large" sx={{ marginRight: 1 }} /> Appointment History
                                </Typography>
                                <TextField
                                    variant="outlined"
                                    placeholder="Search..."
                                ...
                                <TableContainer component={Paper}>
                                    <Table>
                                        <TableHead>
                                            <TableRow>
                                                {['dateTime', 'client', 'venue', 'status', 'actions'].map((header) => (
                                                    <TableCell key={header} style={{ fontWeight: 'bold', cursor: 'pointer' }} onClick={() => this.handleSort(header)}>
                                        ...
                                        <TableBody>
                                            {filteredAppointments.length > 0 ? (
                                                ...
                                                <TableRow>
                                                    <TableCell colSpan={5} align="center">No appointment history found</TableCell>
                                                </TableRow>
                                            )}
                                        </TableBody>
                                    </Table>
